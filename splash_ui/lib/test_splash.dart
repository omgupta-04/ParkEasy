...
class _TestSplashState extends State<TestSplash> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    ).animate(CurvedAnimation(parent: _slideOutController, curve: Curves.easeInOut));
